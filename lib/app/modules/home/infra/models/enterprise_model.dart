...
class EnterpriseModel extends EnterpriseEntity {
  const EnterpriseModel({
    ...
    String description = '',
    String photo = '',
  }) : super(id: id, enterpriseName: enterpriseName, description: description, photo: photo);
  ...
  factory EnterpriseModel.fromJson(String source) => EnterpriseModel.fromMap(json.decode(source));
}
