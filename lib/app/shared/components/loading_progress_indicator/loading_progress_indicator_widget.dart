...
class LoadingProgressIndicatorWidget extends StatelessWidget {
  ...
  const LoadingProgressIndicatorWidget({Key? key, this.opacity = 0.7, this.isCustom = false, this.dismissibles = false, this.color = Colors.black, this.loadingTxt = ''}) : super(key: key);
  @override
